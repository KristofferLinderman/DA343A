...
public class WriteToFile {
	...
	private long[] primes = { 2, 3, 5, 7, 11, 13, 17, 19, 13, 19, 31,1337 };
	...
	public WriteToFile() {
		...
		persons.add(new Person("Guun", 3, 'K'));
	...
	public void writeInvited(String filename) throws IOException {
		try (BufferedWriter br = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(filename), "UTF-8"))) {
