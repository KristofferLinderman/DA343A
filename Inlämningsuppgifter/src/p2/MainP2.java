...
public class MainP2 {
	public static void main(String[] args) {
		...
		IconServer iconServer = new IconServer(iconManager, 3520); // start av
																	// server
		IconClient iconClient = new IconClient("127.0.0.1", 3520); // start av
																	// client1
		new ViewerWindow(new Viewer(iconClient, 320, 320), 100, 450);
		new ViewerWindow(new Viewer(iconClient, 320, 320), 450, 450);
		IconClient iconClient2 = new IconClient("127.0.0.1", 3520); // start av
																	// client2
